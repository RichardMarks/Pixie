...
// MG: Modified: Added setcurrentframe and getcurrentframe methods, and made the "player" method public
...
public:
	...
	ymu32	getPos(void);
	ymu32	getCurrentFrame(void);
	void	setCurrentFrame(ymu32 frame);
